Shader "Custom/SphericalsMaskLayer"
{
    Properties
    {
        ...
        _ColorStrength("Color Stenght", Range(1, 4)) = 1
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
        	...
        	// greyscale
            float greyscale = (c.r + c.g + c.b) * 0.333;
            fixed3 c_g = fixed3(greyscale, greyscale, greyscale);
